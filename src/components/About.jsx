        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 md:gap-8 md:px-4">
          ...
          <div>
            {toggleAbout ? (
              ...
              <div>
                <p className="px-4 float-left text-base sm:text-base md:text-xl md:pb-4">
            ...
            <button
              ...
              className="invisible md:visible pl-4 text-4xl font-bold inline text-yellow-200 hover:text-yellow-400"
            >
              {toggleAbout ? ">" : "<"}
            </button>
          </div>
