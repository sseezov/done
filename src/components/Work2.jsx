...
const Work2 = () => {
  ...
  return (
    <div
      name="work"
      className="w-full m-auto pt-16 md:h-screen text-gray-300 bg-[#0a192f]"
    >
        ...
        <div className="ml-[33px]">
          ...
          >
            ...
            <div className="md:p-8 pt-2 min-h-[500px] md:min-h-[370px] ">
              ...
              <div className="md:flex md:flex-row">
                <img
                  className="m-auto max-w-[280px] max-h-[200px] md:max-h-[250px] rounded-xl p-2 md:hover:scale-150 duration-500"
            ...
            <div className="md:p-8 min-h-[500px] md:min-h-[370px] ">
              ...
              <div className="md:flex md:flex-row">
                <img
                  className="m-auto max-w-[280px] max-h-[200px] md:max-h-[250px] rounded-xl px-2 md:hover:scale-150 duration-500"
